...
struct Image {
	...
	static uint32_t rev(uint32_t n, uint32_t a); //gives bit reversal of a for an log_2(n) bit string
	static void bit_rev(uint32_t n, std::complex<double> a[], std::complex<double>* A); //puts array in bit reversed order
